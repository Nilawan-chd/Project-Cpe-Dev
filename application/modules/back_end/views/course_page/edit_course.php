                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo base_url('backoffice/page/course/course/update/'.$course->id); ?>" method="post" enctype="multipart/form-data">
                                <div style="padding-top: 20px;"><h6><i class="fa fa-tag"></i> Information</h6></div>
                                <hr>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Detail</label>
                                    <div class="col-sm-9">
                                        <textarea class="summernote" name="detail"><?php echo $course->detail; ?></textarea>
                                    </div>
                                </div>
