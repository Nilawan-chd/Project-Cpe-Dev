    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="<?php base_url('backoffice/page/about/faculty') ?>"> เกี่ยวกับ:
                        คณาจารย์</a></div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo base_url('backoffice/page/about/faculty/update/'.$faculty->id); ?>" method="post"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="name_th" value="<?php echo $faculty->name_th;?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">*ชื่ออังกฤษ</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="name_en" value="<?php echo $faculty->name_en;?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="custom-file input-file-w-30">
                                            <input type="file" class="custom-file-input" name="img"
                                                   onchange="PreviewImage(this, 'previewImgCover');" value="<?php echo $faculty->img; ?>">
