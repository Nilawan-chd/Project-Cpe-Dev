    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">แก้ไข หลักสูตร</div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo base_url('backoffice/page/course/course/update/'.$course->id); ?>" method="post"
