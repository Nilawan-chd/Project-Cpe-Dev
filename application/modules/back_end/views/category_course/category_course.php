                                                    ...
                                                    <td>
                                                        <div class="dropdown d-inline">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item has-icon" href="<?php echo base_url('backoffice/page/course/category/edit/' . $category_courses->id); ?>"><i class="far fa-edit"></i> แก้ไข</a>
                                                                <a class="dropdown-item has-icon" onclick="deleteCategoryProduct('<?php echo base_url('backoffice/page/course/category/destroy/' . $category_courses->id); ?>')"><i class="far fa-trash-alt"></i> ลบ</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
