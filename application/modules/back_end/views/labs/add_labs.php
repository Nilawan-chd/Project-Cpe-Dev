    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active">เพิ่ม ห้องปฏิบัติการ</div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo base_url('backoffice/page/lab/lab/store'); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="text-right">
                                    ...
                                    <a href="<?php echo base_url('backoffice/page/lab/lab'); ?> "
