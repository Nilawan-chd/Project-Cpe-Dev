                                ...
                                <table class="table table-striped" id="table-1">
                                    ...
                                    foreach ($banners as $banner) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <img id="previewImgCover"  src="<?php echo base_url('storage/uploads/images/banner/'. $banner->title );?>" style="background-color: #fff;" width="20%">
                                            </td>
...
<script>
    ...
    $(document).ready(function() {
        $('#btnSort').on('click', function() {
            $.ajax({
                type: "POST",
                url: window.base_url + 'backoffice/page/home/banner/ajax/get/banner/sort/show',
                success: function(res) {
        ...
        $('#btnSaveSorting').click(function() {
            ...
            $.ajax({
                type: "POST",
                url: window.base_url + 'backoffice/page/home/banner/ajax/get/banner/sort/update',
                data: {
                    id: selectedID,
                    sort: selectedSort
                },
