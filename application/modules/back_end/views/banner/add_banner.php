        ...
        <div class="section-header">
            <div class="section-header-breadcrumb">
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active">เพิ่ม แบนเนอร์</div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>เพิ่ม แบนเนอร์</h4>
                        </div>
                        <div class="card-body">
                            <form action="<?php echo base_url('backoffice/page/home/banner/store'); ?>" method="post"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="img_title_alt" value="">
                                    </div>
                                </div>
                                <div class="form-group row">
