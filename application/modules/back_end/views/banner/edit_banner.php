            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url('backoffice/page/banner/update/'.$banners->id); ?>" method="post"
                                    ...
                                    <div class="col-sm-9">
                                        <div class="custom-file input-file-w-30">
                                            <input type="file" class="custom-file-input" name="img_cover"
                                                   onchange="PreviewImage(this, 'previewImgCover');" value="<?php echo $banners->title; ?>" required>
